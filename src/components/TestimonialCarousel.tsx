      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-xl font-medium text-maker-blue ml-2">4.9/5 Rating</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonials.map((testimonial) => (
            <Card key={testimonial.id} className="bg-white/60 hover:bg-white transition-all duration-300 hover:shadow-lg border-maker-blue/10">
              <CardContent className="p-6">
                ...
                <div className="border-t border-maker-blue/10 pt-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-medium text-maker-blue">{testimonial.name}</h4>
                      <p className="text-sm text-slate-600">{testimonial.location}</p>
                    </div>
                  </div>
                  <Badge variant="secondary" className="bg-oak/20 text-maker-blue text-xs mt-2">
                    {testimonial.product}
                  </Badge>
                </div>
              </CardContent>
        ...
        <div className="mt-16 text-center">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-slate-700">Quality Guarantee</p>
            </div>
          </div>
        </div>
      </div>
